...
const ROAD_COLOR = [
  ...
  [
    "match",
    ["get", "class"],
    ["motorway", "trunk"], "#b9c2cc",
    ["primary", "secondary"], "#ffffff",
    ["tertiary"], "#fbfcfd",
    ["street", "street_limited", "service", "track"], "#f2f4f6",
    ["path", "pedestrian"], "#e9ecef",
    ["major_rail", "minor_rail"], "#c3c9d0",
    "#eef0f3",
  ],
];
...
const ROAD_WIDTH = [
  ...
  5, ["match", ["get", "class"], ["motorway", "trunk"], 0.8, ["primary"], 0.5, 0.2],
  12, [
    "match", ["get", "class"],
    ["motorway", "trunk"], 2.6,
    ["primary", "secondary"], 1.8,
    ["tertiary"], 1.2,
    ["major_rail", "minor_rail"], 0.8,
    0.7,
  ],
  16, [
    "match", ["get", "class"],
    ...
    ["primary", "secondary"], 8,
    ["tertiary"], 6,
    ["street", "street_limited"], 5,
    ["major_rail", "minor_rail"], 1.6,
    3,
  ],
];
...
export function buildCityStyle(lang: string): StyleSpecification {
  ...
  return {
    ...
    layers: [
      ...
      {
        id: "landuse", type: "fill", source: "streets", "source-layer": "landuse", minzoom: 5,
        filter: ["match", ["get", "class"],
          ["park", "grass", "pitch", "wood", "scrub", "cemetery", "residential", "industrial", "airport", "hospital", "school", "sand", "glacier"],
          true, false],
        paint: {
          "fill-color": ["match", ["get", "class"],
            ["park", "grass", "pitch"], "#dde5dd",
            ["wood", "scrub"], "#d4ddd4",
            ["cemetery"], "#dce2dc",
            ["residential"], "#e3e5e9",
            ["industrial"], "#dcdee3",
            ["airport"], "#e0e3e8",
            ["hospital", "school"], "#e2e3e6",
            ["sand"], "#e8e7e2",
            ["glacier"], "#eef1f4",
            "#e6e8eb"],
        },
      ...
      {
        id: "landuse-overlay", type: "fill", source: "streets", "source-layer": "landuse_overlay", minzoom: 5,
        paint: {
          "fill-color": ["match", ["get", "class"],
            "national_park", "#dbe4db",
            "wetland", "#dbe2e6",
            "wetland_noveg", "#dee4e7",
            "#e6e8eb"],
          "fill-opacity": 0.6,
        },
      },
      ...
      {
        id: "waterway", type: "line", source: "streets", "source-layer": "waterway", minzoom: 8,
        filter: ["match", ["get", "class"], ["river", "canal", "stream", "drain", "ditch"], true, false],
        layout: { "line-cap": "round", "line-join": "round" },
        paint: {
          "line-color": "#bcc8d3",
          "line-width": ["interpolate", ["linear"], ["zoom"],
            10, ["match", ["get", "class"], "river", 1, "canal", 0.7, 0.4],
            16, ["match", ["get", "class"], "river", 4.5, "canal", 2.5, 1.2]],
        },
      },

      {
        id: "road-line", type: "line", source: "streets", "source-layer": "road", minzoom: 3,
        filter: ["match", ["get", "class"], ["ferry", "ferry_auto", "aerialway", "golf"], false, true],
        layout: { "line-cap": "round", "line-join": "round" },
        paint: { "line-color": ROAD_COLOR, "line-width": ROAD_WIDTH },
      },

      {
        id: "building-3d", type: "fill-extrusion", source: "streets", "source-layer": "building", minzoom: 13,
        filter: ["all", ["==", ["get", "extrude"], "true"], ["!=", ["get", "underground"], "true"]],
        paint: {
          "fill-extrusion-color": ["interpolate", ["linear"], ["get", "height"],
            0, "#d6dade", 60, "#dfe3e8", 180, "#eef1f5"],
      ...
      {
        id: "admin", type: "line", source: "streets", "source-layer": "admin", minzoom: 0,
      ...
      {
        id: "admin-disputed", type: "line", source: "streets", "source-layer": "admin", minzoom: 0,
      ...
      {
        id: "housenum-label", type: "symbol", source: "streets", "source-layer": "housenum_label", minzoom: 16,
      ...
      {
        id: "natural-label", type: "symbol", source: "streets", "source-layer": "natural_label", minzoom: 4,
        layout: {
          "text-field": NAME, "text-font": FONT_REGULAR,
          "text-size": ["interpolate", ["linear"], ["zoom"], 4, 10, 14, 14],
          "icon-image": ["get", "maki"],
        },
        paint: {
          "text-color": ["match", ["get", "class"],
            ["water", "sea", "ocean", "reservoir", "river", "canal", "bay", "stream"], "#6c7d8c",
            "#6b7280"],
          "text-halo-color": "#ffffff", "text-halo-width": 1,
        },
      },
      {
        id: "transit-label", type: "symbol", source: "streets", "source-layer": "transit_stop_label", minzoom: 14,
        layout: {
          "text-field": NAME, "text-font": FONT_REGULAR, "text-size": 10,
      ...
      {
        id: "poi-label", type: "symbol", source: "streets", "source-layer": "poi_label", minzoom: 13,
        filter: ["<=", ["get", "filterrank"], 3], // label density control
        layout: {
          "text-field": NAME, "text-font": FONT_REGULAR, "text-size": 11,
          "text-offset": [0, 1], "text-anchor": "top",
          "icon-image": ["get", "maki"],
        },
      ...
      {
        id: "place-label", type: "symbol", source: "streets", "source-layer": "place_label", minzoom: 0,
        filter: ["match", ["get", "class"],
          ["country", "state", "settlement", "settlement_subdivision"], true, false],
        layout: {
          "text-field": NAME,
          "text-font": ["match", ["get", "class"], ["country", "settlement"], FONT_MEDIUM, FONT_REGULAR],
          // symbolrank drives prominence: low rank (major places) → larger text
          "text-size": ["interpolate", ["linear"], ["zoom"],
            2, ["step", ["get", "symbolrank"], 12, 4, 10, 8, 9],
            12, ["step", ["get", "symbolrank"], 20, 4, 17, 8, 14, 12, 12]],
        },
