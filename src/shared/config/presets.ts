...
export const PRESETS: Preset[] = [
  ...
  { name: "Everest", lat: 27.9881, lng: 86.925, areaKm: 22 },
  ...
  { name: "Mount Elbrus", lat: 43.355, lng: 42.4392, areaKm: 20 },
  // Himalaya / Karakoram
  { name: "Kangchenjunga", lat: 27.7025, lng: 88.1475, areaKm: 20 },
  { name: "Lhotse", lat: 27.9617, lng: 86.933, areaKm: 14 },
  ...
  { name: "Mount Olympus", lat: 40.085, lng: 22.3586, areaKm: 14 },
  { name: "Mount Etna", lat: 37.751, lng: 14.9934, areaKm: 35 },
  ...
  { name: "Manhattan", lat: 40.7549, lng: -73.984, areaKm: 0.5, city: true },
