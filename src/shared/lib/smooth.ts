...
/**
 * Round off sharp ridges in a GRID×GRID heightfield with a separable binomial
 * (1-2-1) blur. Each iteration is one Gaussian pass; edges clamp so the border
 * isn't pulled inward. Returns a new array; the input is left untouched.
 */
